      ...
      <DocSection title="States">
        <div className="rounded-(--radius-m) border border-(--color-border) bg-(--color-bg-page) p-8 flex flex-wrap gap-4 items-start">
          <div className="flex flex-col gap-2 items-start">
            <span className="text-xs font-medium text-(--color-text-secondary)">Default</span>
          ...
          <div className="flex flex-col gap-2 items-start">
            <span className="text-xs font-medium text-(--color-text-secondary)">Hover</span>
          ...
          <div className="flex flex-col gap-2 items-start">
            <span className="text-xs font-medium text-(--color-text-secondary)">Selected</span>
          ...
          <div className="flex flex-col gap-2 items-start">
            <span className="text-xs font-medium text-(--color-text-secondary)">Disabled</span>
